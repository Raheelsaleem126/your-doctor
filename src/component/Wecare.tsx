        ...
        <div className="row content-wrapper style-11 m-b30 justify-content-center">
          ...
          <div className="col-xxl-6 col-xl-7 col-lg-7">
            <div className="content-info pt-md-5 m-b30">
              <div
                className="section-head style-3 m-b30 wow fadeInUp"
                data-wow-delay="0.2s"
              ...
              <div
                className="info-widget style-15 overlay-secondary-dark wow fadeInUp"
                data-wow-delay="0.4s"
                data-wow-duration="0.8s"
                ...
                <div className="row">
                  <div className="col-sm-6">
                    <ul className="list-check-try text-white light-green fw-medium">
                      ...
                      <li>
                        Family & Preventive <br /> Care{" "}
                      </li>
                    </ul>
                  </div>
                  <div className="col-sm-6">
                    <ul className="list-check-try text-white light-green fw-medium">
                      <li>Women’s Health & Wellness</li>
                      <li>Men’s Health Screening</li>
                      <li>Pediatric Care & Child Wellness</li>
                      <li>Nutrition & Lifestyle Counseling</li>
                    </ul>
                  </div>
                </div>
              </div>
          ...
          <div className="col-xxl-2">
            <div className="row counter-item">
              {counterdata.map((data, i) => (
                <div
                  key={i}
                  className="col-xxl-12 col-sm-4 col-6 wow fadeInRight"
                  data-wow-delay={data.delay}
                  data-wow-duration="0.8s"
                >
                  <div
                    className={`content-bx style-3 m-b30 text-center ${data.columnstand1}`}
                  >
                    <span className="content-text text-secondary">
                      <span className="counter">{data.count}</span>
                      {data.span}
                    </span>
                    <h3 className={`title m-b0 ${data.columnstand2}`}>
                      {data.title}
                    </h3>
                  </div>
                </div>

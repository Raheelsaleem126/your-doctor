                  ...
                  >
                    <div className="dz-team style-6">
                      ...
                      <ul className="dz-social">
                        ...
                        <li>
                          <Link
                            href="https://wa.me/447540634228?text=Hello%2C%20I%20would%20like%20to%20book%20an%20appointment."
                            target="_blank"
                          >
              ...
              <div className="col-lg-6">
                <div className="section-head style-1 mb-30">
                  ...
                  <p
                    ...
                    data-wow-duration="0.8s"
                  >
                    Private GP | MBBS | MRCGP | Over 15 Years of NHS Experience
                  </p>
                  <p
                    ...
                    data-wow-duration="0.8s"
                  >
                    Dr Samira Masoud is a highly experienced and compassionate
                    General Practitioner with over 15 years of clinical
                    experience in the NHS. She now offers private GP services
                    with a strong focus on personalised, patient-centred care.
                  </p>
                ...
                >
                  ...
                  <ul className="list-unstyled">
                    <li className="m-b15">
                      <strong>Women’s Health:</strong> Supporting women through
                      all stages of life, from reproductive health to
                      postmenopausal care, with a holistic and empathetic
                      approach.
                    </li>
                    <li className="m-b15">
                      <strong>Menopause Management:</strong> Extensive
                      experience in diagnosing and treating menopause-related
                      symptoms, offering evidence-based HRT options and
                      lifestyle support.
                    </li>
                    <li className="m-b15">
                      <strong>Mental Health:</strong> Skilled in managing
                      anxiety, depression, stress, and other mental health
                      conditions, with a focus on early intervention and
                      continuity of care.
                    </li>
                    <li className="m-b15">
                      <strong>Palliative Care:</strong> Dedicated to providing
                      compassionate support and symptom control for patients
                      with life-limiting conditions, ensuring dignity and
                      comfort.
                    </li>
                    <li className="m-b15">
                      <strong>Joint Injections:</strong> Proficient in
                      performing steroid joint injections for conditions such as
                      arthritis and bursitis to relieve pain and improve
                      mobility.
                    </li>
                    <li className="m-b15">
                      <strong>Minor Surgery:</strong> Experienced in carrying
                      out minor surgical procedures, including removal of skin
                      lesions, cysts, and other minor interventions.
                    </li>
                  </ul>
                </div>
